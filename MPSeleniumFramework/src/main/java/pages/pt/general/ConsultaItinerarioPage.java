...
public class ConsultaItinerarioPage {
	private WebDriverWait wait;
	private WebDriver driver;
	private static Logger logger = LogManager.getLogger(ConsultaItinerarioPage.class);
	
	//Constructor
	public ConsultaItinerarioPage(WebDriver _driver){
	...
	public boolean isAt() {
		...
		return driver.getTitle().contains("Consulta tu itinerario");
	}
