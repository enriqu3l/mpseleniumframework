...
public class HomePaquetesPage {
	private WebDriverWait wait;
	private WebDriver driver;
	private static Logger logger = LogManager.getLogger(HomePaquetesPage.class);
	
	//Constructor
	public HomePaquetesPage(WebDriver _driver){
	...
	public void goTo() {
		Pages.topnav(driver).clickPaquetes();
	}
	
	public boolean isAt() {
		//Verificar que estoy en esta pagina
		return driver.getTitle().contains("Mejores ofertas");
	}
